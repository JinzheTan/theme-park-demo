export const TOOLS = [
  ...
  { id: "food",      group: "Facilities", label: "Food Stall",     detail: "Feeds guests and lifts mood.",       cost: 170 },
  { id: "service",   group: "Facilities", label: "Care Hub",       detail: "Keeps litter under control.",        cost: 220 },
...
export const TOOL_GROUPS = ["Build", "Rides", "Facilities", "Scenery"];
